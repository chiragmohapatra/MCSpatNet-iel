...
parser.add_argument("--root", type=str, default='./train_output', help="name of checkpoint folder")

args = parser.parse_args()
checkpoints_root_dir = args.root # The root directory for all training output.
