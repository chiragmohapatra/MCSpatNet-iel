...
parser.add_argument("--name", type=str, default="mcspatnet_monusac", help="name of checkpoint folder")
...
cell_code = {1:'Epithelial', 2:'Lymphocyte', 3:'Neutrophil', 4:'Macrophage'}
...
if __name__=="__main__":
    ...
    n_channels = 3
    n_classes = 4 # number of cell classes (lymphocytes, tumor, stromal)
    ...
    class_indx = '1,2,3,4' # the index of the classes channels in the ground truth
